    ...
    private void setUpdateCheckState(UpdateCheckState newState) {
        ...
        switch (newState) {
            ...
            case UPDATE_AVAILABLE:
                output.setText(getResources().getString(R.string.update_check_update_available,
                        updateCheckResult.getLatestRelease().getVersion()));
                break;
        }
    }

    public void checkForUpdates(View view) {
        if (updateCheckState == UpdateCheckState.BUSY) return;
